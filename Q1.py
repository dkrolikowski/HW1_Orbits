...
class OrbitPredictor():
    ...
    def FindTransits( self, tarr ):
        ...
        # Look for when the projected sep is less than the stellar radius (ignore planet radius/grazing transits)
        # AND when the planet is in front of the star
...
raoft  += pma * ( tarr - tarr[0] ) - ra
decoft += pmd * ( tarr - tarr[0] ) - dec
